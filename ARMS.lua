...
-- FlyWithLua для X-Plane 12 (v8.6 - финальная проверка)
-- ============================================================
...
-- DataRef'ы с правильными именами для X-Plane 12
...
local cmd_aileron = globalPropertyf("sim/flightmodel/controls/aileron_def")
